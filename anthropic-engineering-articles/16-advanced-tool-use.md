...
#### Example: Budget Compliance Check | 预算合规检查示例
示例：预算合规检查
...
### Layer Features Strategically | 战略性地分层功能
战略性分层功能
...
### Set Up Tool Search Tool for Better Discovery | 设置工具搜索工具以实现更好的发现
设置工具搜索工具以更好地发现
...
### Set Up Programmatic Tool Calling for Correct Execution | 设置编程式工具调用以实现正确执行
设置编程式工具调用以正确执行
...
- [Documentation and cookbook for Tool Search Tool](https://docs.anthropic.com/en/docs/build-with-claude/tool-use)
- 工具搜索工具的文档和手册
- [Documentation and cookbook for Programmatic Tool Calling](https://docs.anthropic.com/en/docs/build-with-claude/tool-use)
- 编程式工具调用的文档和手册
- [Documentation for Tool Use Examples](https://docs.anthropic.com/en/docs/build-with-claude/tool-use)
- 工具使用示例的文档
