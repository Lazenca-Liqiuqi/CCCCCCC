...
<em>Contextual Retrieval is a preprocessing technique that improves retrieval accuracy.</em>
...
<em>Combining Contextual Embedding and Contextual BM25 reduce the top-20-chunk retrieval failure rate by 49%.</em>
...
<em>Combine Contextual Retrieva and Reranking to maximize retrieval accuracy.</em>
...
<em>Reranked Contextual Embedding and Contextual BM25 reduces the top-20-chunk retrieval failure rate by 67%.</em>
...
<em>1 minus recall @ 20 results across data sets and embedding providers.</em>
