...
![](/_next/image?url=https%3A%2F%2Fwww-cdn.anthropic.com%2Fimages%2F4zrzovbb%2Fwebsite%2Fddd7e6e572ad0b6a943cacefe957248455f6d522-1650x929.jpg&amp;w=3840&amp;q=75)
...
At its simplest, a skill is a directory that contains a `SKILL.md file`{.InlineCodeBlock-module-scss-module__nsPAba__code}. This file must start with YAML frontmatter that contains some required metadata: `name`{.InlineCodeBlock-module-scss-module__nsPAba__code} and `description`{.InlineCodeBlock-module-scss-module__nsPAba__code}. At startup, the agent pre-loads the `name`{.InlineCodeBlock-module-scss-module__nsPAba__code} and `description`{.InlineCodeBlock-module-scss-module__nsPAba__code} of every installed skill into its system prompt.

This metadata is the **first level** of *progressive disclosure*: it provides just enough information for Claude to know when each skill should be used without loading all of it into context. The actual body of this file is the **second level** of detail. If Claude thinks the skill is relevant to the current task, it will load the skill by reading its full `SKILL.md`{.InlineCodeBlock-module-scss-module__nsPAba__code} into context.

![](/_next/image?url=https%3A%2F%2Fwww-cdn.anthropic.com%2Fimages%2F4zrzovbb%2Fwebsite%2F6f22d8913dbc6228e7f11a41e0b3c124d817b6d2-1650x929.jpg&amp;w=3840&amp;q=75)
...
As skills grow in complexity, they may contain too much context to fit into a single `SKILL.md`{.InlineCodeBlock-module-scss-module__nsPAba__code}, or context that's relevant only in specific scenarios. In these cases, skills can bundle additional files within the skill directory and reference them by name from `SKILL.md`{.InlineCodeBlock-module-scss-module__nsPAba__code}. These additional linked files are the **third level** (and beyond) of detail, which Claude can choose to navigate and discover only as needed.

In the PDF skill shown below, the `SKILL.md`{.InlineCodeBlock-module-scss-module__nsPAba__code} refers to two additional files (`reference.md`{.InlineCodeBlock-module-scss-module__nsPAba__code} and `forms.md`{.InlineCodeBlock-module-scss-module__nsPAba__code}) that the skill author chooses to bundle alongside the core `SKILL.md`{.InlineCodeBlock-module-scss-module__nsPAba__code}. By moving the form-filling instructions to a separate file (`forms.md`{.InlineCodeBlock-module-scss-module__nsPAba__code}), the skill author is able to keep the core of the skill lean, trusting that Claude will read `forms.md`{.InlineCodeBlock-module-scss-module__nsPAba__code} only when filling out a form.

![](/_next/image?url=https%3A%2F%2Fwww-cdn.anthropic.com%2Fimages%2F4zrzovbb%2Fwebsite%2F191bf5dd4b6f8cfe6f1ebafe6243dd1641ed231c-1650x1069.jpg&amp;w=3840&amp;q=75)
...
![](/_next/image?url=https%3A%2F%2Fwww-cdn.anthropic.com%2Fimages%2F4zrzovbb%2Fwebsite%2F441b9f6cc0d2337913c1f41b05357f16f51f702e-1650x929.jpg&amp;w=3840&amp;q=75)
...
2.  Claude triggers the PDF skill by invoking a Bash tool to read the contents of `pdf/SKILL.md`{.InlineCodeBlock-module-scss-module__nsPAba__code};
3.  Claude chooses to read the `forms.md`{.InlineCodeBlock-module-scss-module__nsPAba__code} file bundled with the skill;
...
![](/_next/image?url=https%3A%2F%2Fwww-cdn.anthropic.com%2Fimages%2F4zrzovbb%2Fwebsite%2Fc24b4a2ff77277c430f2c9ef1541101766ae5714-1650x929.jpg&amp;w=3840&amp;q=75)
...
Agent Skills are [supported today](https://www.anthropic.com/news/skills) across [Claude.ai](http://claude.ai/redirect/website.v1.08ca5b0a-3c50-4742-8aad-89eec8ae81fb), Claude Code, the Claude Agent SDK, and the Claude Developer Platform.
