...
1.  Initializer agent: The very first agent session uses a specialized prompt that asks the model to set up the initial environment: an `init.sh`{.InlineCodeBlock-module-scss-module__nsPAba__code} script, a claude-progress.txt file that keeps a log of what agents have done, and an initial git commit that shows what files were added.
...
### Testing 
One final major failure mode that we observed was Claude's tendency to mark a feature as complete without proper testing. Absent explicit prompting, Claude tended to make code changes, and even do testing with unit tests or `curl`{.InlineCodeBlock-module-scss-module__nsPAba__code} commands against a development server, but would fail recognize that the feature didn't work end-to-end.
...
![](/_next/image?url=https%3A%2F%2Fwww-cdn.anthropic.com%2Fimages%2F4zrzovbb%2Fwebsite%2Ff94c2257964fb2d623f1e81f874977ebfc0986bc-1920x1080.gif&amp;w=3840&amp;q=75)
...
1.  *Run `pwd`{.InlineCodeBlock-module-scss-module__nsPAba__code} to see the directory you're working in. You'll only be able to edit files in this directory.*
...
Agent failure modes and solutions
  ...
  **Problem**                                                                    **Initializer Agent Behavior**                                                                                                       **Coding Agent Behavior**
  ...
  Claude has to spend time figuring out how to run the app.                      Write an `init.sh`{.InlineCodeBlock-module-scss-module__nsPAba__code} script that can run the development server.                    Start the session by reading `init.sh`{.InlineCodeBlock-module-scss-module__nsPAba__code}.
  ------------------------------------------------------------------------------ ------------------------------------------------------------------------------------------------------------------------------------ -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
